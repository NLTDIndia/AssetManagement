...
import { OtherAssetTypeSpecification } from '../shared/raisepo.model';
...
export class PaymentdetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.raisePoService.getPaymentDetails(this._assetRequestId);
    ...
    //this.raisePoService.selectedOtherAssetTypeSpecification.AssetTypeOtherpecification = 'string';
  }
  ...
  onBackButtonClick() {
    this._router.navigate(['/assetrequests/raisepos/raisepos']);
  }
  ...
  confirm(): void {
    ...
    this.modalRef.hide();
    this.raisePoService.DeletePaymentsById(this.PaymentId, this.currentUser.UserId)
      .subscribe(x => {
        this.raisePoService.getPaymentDetails(this._assetRequestId);
      });
    this.PaymentId = "";
  ...
  resetForm() {
    ...
    this.raisePoService.selectedOtherAssetTypeSpecification = {
      AssetTypeOtherpecification: ''
    }
  }
  ...
  onPaymentSubmit(form: NgForm) {
    ...
    if (temp == 0) {
      ...
      this.raisePoService.InsertPaymentDetails(AssetRequestPayments.AssetRequestId,this.currentUser.UserId,
        AssetRequestPayments.SpecificationArray)
        .subscribe(data => {
          this.resetForm();
          this.toastr.success('Payment has been saved successfully.');
          this.raisePoService.getPaymentDetails(AssetRequestPayments.AssetRequestId);
        }, (error) => {
          console.log(error);
        })
    }
  ...
  btnClickView = function () {
    this._router.navigate(['/assetrequests/viewraisepo/viewraisepo'], { queryParams: { AssetRequestId: this._navigateAssetRequestId, ARNumber: this._arNumber } });
  };
  btnSaveOtherSpecification(OtherSpecification) {
    console.log(OtherSpecification);
    // this.raisePoService.postAssetTypeOtherSpecification(this._navigateAssetRequestId,
    //   OtherSpecification)
    //   .subscribe(data => {
    //     this.resetForm();
    //     this.toastr.success('Other Specifications has been saved successfully.');
    //     this.raisePoService.selectedOtherAssetTypeSpecification = {
    //       AssetTypeOtherpecification: ''
    //     }
    //   }, (error) => {
